...
import './HomeStyles/HomeCategory.css'

export default function HomeCategory() {
    return (
        <div className='py-5 text-white' style={{ backgroundColor: '#EDEFEE'}}>
            <h1 className='text-center mb-5 text-dark'>Explore By Category</h1>
